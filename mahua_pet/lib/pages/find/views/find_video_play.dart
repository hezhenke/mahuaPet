...
class FindVideoPlay extends StatefulWidget {
  ...
  FindVideoPlay({Key key, this.canPlay, this.videoModel, this.actionCallback})
      : super(key: key);
...
class _FindVideoPlayState extends State<FindVideoPlay> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: <Widget>[renderVideoItem(), renderBottomBar(context)],
      ),
    );
  }
  ...
  Widget renderVideoItem() {
    ...
    Widget indicator = Stack(
      children: <Widget>[
        Image.network(widget.videoModel.videoCover,
            fit: BoxFit.contain,
          ...
          children: <Widget>[
            ...
            Positioned(
                child: _isPlaying
                    ...
                    : Center(
                        child: Image.asset(
                            TKImages.image_path + 'video_play.png',
                            width: 55.px,
                            height: 55.px)))
          ],
        )),
  ...
  Widget renderUserInfo() {
    return Row(
      children: <Widget>[
        ...
        Text(widget.videoModel.nickName,
            style: TextStyle(fontSize: 16.px, color: TKColor.white))
      ],
    );
  }
  ...
  Widget renderMessage() {
    return Container(
      ...
      child: Text(widget.videoModel.messageInfo,
    ...
    return Row(
      children: <Widget>[
        Text(getTimer(_currentTime),
            style: TextStyle(fontSize: 12.px, color: TKColor.white)),
        SizedBox(width: 10.px),
        Expanded(
          child: Container(
            height: 2.px,
  ...
  void _videoChanged() {
    if (widget.videoModel == null ||
        widget.videoModel.fileUrl == null ||
        widget.videoModel.fileUrl.length <= 0) {
